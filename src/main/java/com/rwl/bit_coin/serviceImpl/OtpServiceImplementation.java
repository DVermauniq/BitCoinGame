...
import com.rwl.bit_coin.configuration.TwilioConfig;
import com.rwl.bit_coin.exception.OTPExpireException;
    ...
    public ResponseEntity<String> sendPhoneOtp(String phoneNumber) throws Exception {
        try {
            ...
            String otpMessage = "Dear Customer, your OTP is " + otp
                    + " for sending SMS through Bit-coin application. Thank you.";
